...
import com.foodorder.foodorderadmin.Model.AdminOrders;
...
//        final DatabaseReference cartListRef = FirebaseDatabase.getInstance().getReference().child("Cart List");
        ...
        FirebaseRecyclerAdapter<AdminOrders,AdminOrdersViewHolders> adapter= new FirebaseRecyclerAdapter<AdminOrders, AdminOrdersViewHolders>(options) {
            @Override
            protected void onBindViewHolder(@NonNull AdminOrdersViewHolders holder, final int position, @NonNull final AdminOrders model) {
    ...
    public static class AdminOrdersViewHolders extends RecyclerView.ViewHolder{
        ...
        public TextView userName,userPhoneNumber,userTotalPrice,userDateTime,orderStatus,DeliveryStatus,address;
