...
import com.foodorder.foodorderadmin.Model.Users;
import com.foodorder.foodorderadmin.Prevalent.Prevalent;
...
//            AllowAccessToAccount(phone, password);
    ...
    void AllowLogin(String Password, String phoneNo)
    {
        ...
        Log.d("DB Con", "Database Conn" + reference.getDatabase().toString());
